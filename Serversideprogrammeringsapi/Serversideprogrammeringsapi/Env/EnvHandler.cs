...
namespace Serversideprogrammeringsapi.Env
{
    public class EnvHandler
    {
        ...
        {
            DotNetEnv.Env.Load();
            string defaultKey = "+sHNeEAP7icPOsIN3O1nxUiZ3Qqy3NieBWOjViFP4owafWXZX9CeEsVfGfpDI6U6i3jx3IkIlDPc/T5t8HDm0A==";
            return DotNetEnv.Env.GetString("OTP_KEY", defaultKey);
        }

        public static string UserDBString()
        {
            DotNetEnv.Env.Load();
            return $"Server={DotNetEnv.Env.GetString("DB_USER_SERVER")},{DotNetEnv.Env.GetInt("DB_USER_PORT")}; Database={DotNetEnv.Env.GetString("DB_USER_DATABASE")}; User ID={DotNetEnv.Env.GetString("DB_USER_USER")}; Password={DotNetEnv.Env.GetString("DB_USER_PASS")};";
        }

        public static string ToDoDBString()
        {
            DotNetEnv.Env.Load();
            return $"Server={DotNetEnv.Env.GetString("DB_TODO_SERVER")},{DotNetEnv.Env.GetInt("DB_TODO_PORT")}; Database={DotNetEnv.Env.GetString("DB_TODO_DATABASE")}; User ID={DotNetEnv.Env.GetString("DB_TODO_USER")}; Password={DotNetEnv.Env.GetString("DB_TODO_PASS")};";
        }

        public static JwtIssuerOptions GetJWTOptions()
        {
            DotNetEnv.Env.Load();
            string audience = DotNetEnv.Env.GetString("JWT_AUDIENCE", "https://localhost:7248/");
            string issuer = DotNetEnv.Env.GetString("JWT_ISSUER", "data");
            string key = DotNetEnv.Env.GetString(
                "JWT_KEY",
                "+sHNeEAP7icPOsIN3O1nxUiZ3Qqy3NieBWOjViFP4owafWXZX9CeEsVfGfpDI6U6i3jx3IkIlDPc/T5t8HDm0A=="
                );
